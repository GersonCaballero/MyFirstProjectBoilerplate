...
namespace MyFirstProjectBoilerPlate.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(MyFirstProjectBoilerPlateDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new MyFirstProjectBoilerPlateAuthorizationProvider())

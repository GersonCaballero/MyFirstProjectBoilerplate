...
using MyFirstProjectBoilerPlate.Sessions;
using MyFirstProjectBoilerPlate.Web.Controllers.Results;
using MyFirstProjectBoilerPlate.Web.Models;
using MyFirstProjectBoilerPlate.Web.Models.Account;
...
{
    public class AccountController : MyFirstProjectBoilerPlateControllerBase
    {
